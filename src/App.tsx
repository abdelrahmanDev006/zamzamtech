...
const AppContent = () => {
  ...
  return (
    <>
          ...
          <div className="container">
            <div className="footer-content">
              ...
              <div className="social-links">
                ...
                <a href="https://wa.me/201009693397?text=مرحباً زمزم تك، أود الحصول على استشارة تقنية مجانية لمشروعي!" target="_blank" rel="noopener noreferrer" className="icon-btn" aria-label="WhatsApp" onMouseEnter={() => setIsHovering(true)} onMouseLeave={() => setIsHovering(false)}>
      ...
      {/* Floating Buttons */}
      <a 
        href="https://wa.me/201009693397?text=مرحباً زمزم تك، أود الحصول على استشارة تقنية مجانية لمشروعي!" 
        target="_blank" 
