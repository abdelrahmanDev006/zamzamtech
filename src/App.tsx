        ...
        <div className="container">
          <div className="footer-content">
            ...
            <div className="social-links">
              ...
              <a href="https://wa.me/20100444566" target="_blank" rel="noopener noreferrer" className="icon-btn" aria-label="WhatsApp" onMouseEnter={() => setIsHovering(true)} onMouseLeave={() => setIsHovering(false)}>
